...
# ----------------------- CONSTANTS (allowed values for UI) -----------------------
...
# -------- CSV export (KEEP BEFORE any /staff/{staff_id} routes) --------
...
# ---- JSON create/update/delete (for apps; Accept: application/json)
@admin.post("/staff")
